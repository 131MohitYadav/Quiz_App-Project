let questions = [
    {
        prompt: ` Which SQL statement is used to retrieve all data from a table named "employees"?`,
        options: [
    ...
    {
        prompt: ` What is the primary purpose of the SQL "WHERE" clause?`,
        options: [
    ...
    {
        prompt: ` What will be the result of the following SQL query?\n
SELECT COUNT(*) FROM customers WHERE age > 30;`,
    ...
    {
        prompt: ` Which SQL keyword is used to remove duplicate records from a query result?`,
        options: ["UNIQUE", "DISTINCT", "REMOVE DUPLICATES", "FILTER"],
        answer: "DISTINCT",
    },
    {
        prompt: ` What is the default sorting order when using ORDER BY in SQL?`,
...
SELECT name FROM employees WHERE salary > 50000 AND department = 'HR';`,
    ...
    {
        prompt: ` Which SQL clause is used to group records that have the same values?`,
        options: ["ORDER BY", "GROUP BY", "FILTER", "SORT"],
        answer: "GROUP BY",
    },
    {
        prompt: ` What is the purpose of the SQL JOIN statement?`,
        options: [
    ...
    {
        prompt: ` Which SQL function is used to find the highest value in a column?`,
        options: ["MAX()", "TOP()", "HIGHEST()", "UPPER()"],
        answer: "MAX()",
    },
    {
        prompt: ` What is the purpose of the SQL "HAVING" clause?`,
        options: [
