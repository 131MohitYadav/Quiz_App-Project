let questions = [
    {
        prompt: `What is the correct syntax to print "Hello, World!" in C++?`,
        options: [
            `printf("Hello, World!");`,
            `cout << "Hello, World!";`,
...
int main() {
    ...
    {
        prompt: `Which of the following is NOT a valid C++ loop?`,
        options: ["for", "while", "repeat", "do-while"],
        answer: "repeat",
    },
    {
        prompt: `What will be the output of the following C++ program?\n
#include <iostream>
using namespace std;
int main() {
    int arr[] = {10, 20, 30, 40};
    ...
    {
        prompt: ` Which header file is required for using \`cout\` and \`cin\` in C++?`,
...
int main() {
    ...
    {
        prompt: `What is the purpose of the \`delete\` operator in C++?`,
        options: [
            "To delete files",
