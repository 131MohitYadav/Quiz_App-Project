let questions = [
    ...
    {
        prompt: `What will be the output of the following HTML code?\n
<!DOCTYPE html>
<html>
<body>
    ...
    {
        prompt: `What does the "alt" attribute in an <img> tag do?`,
        options: [
    ...
    {
        prompt: `How do you create a checkbox in HTML?`,
        options: [
            '<input type="checkbox">',
            '<checkbox>',
            '<input checkbox="true">',
    ...
    {
        prompt: ` Which tag is used to define a table row?`,
        options: ["<td>", "<tr>", "<th>", "<row>"],
        answer: "<tr>",
    },
    {
        prompt: `Which tag is used to define the metadata of an HTML document?`,
