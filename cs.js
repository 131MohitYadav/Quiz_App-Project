let questions = [
    ...
    {
        prompt: `Which property is used to change the text color of an element?`,
        options: ["color", "text-color", "fgcolor", "font-color"],
        answer: "color",
    },
    {
        prompt: `What will be the background color of the following CSS code?\n
body {
    ...
    {
        prompt: `Which CSS property is used to set the background image of an element?`,
        options: ["background-image", "bg-image", "background", "image"],
        answer: "background-image",
    },
    {
        prompt: ` How do you make text bold using CSS?`,
        options: [
            "font-style: bold;",
            "text-weight: bold;",
            "font-weight: bold;",
    ...
    {
        prompt: `How do you apply a style to multiple elements with the same class?`,
        options: [
            ".classname { }",
            "#classname { }",
            "element.classname { }",
    ...
    {
        prompt: `Which CSS property is used to make the text italic?`,
        options: ["text-style", "font-style", "italic", "text-italic"],
        answer: "font-style",
    },
    {
        prompt: `What is the correct CSS syntax to center an element horizontally?`,
        options: [
            "margin: auto;",
            "align: center;",
            "padding: center;",
    ...
    {
        prompt: `Which CSS property is used to create space around elements?`,
