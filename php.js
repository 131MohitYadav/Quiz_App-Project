let questions = [
    ...
    {
        prompt: `Which symbol is used to declare a variable in PHP?`,
        options: ["$", "@", "#", "&"],
        answer: "$",
    },
    {
        prompt: ` What will be the output of the following PHP code?\n
<?php
$x = 5;
echo $x + 10;
?>`,
    ...
    {
        prompt: `Which function is used to output text in PHP?`,
        options: ["print()", "echo", "display()", "show()"],
        answer: "echo",
    },
    {
        prompt: `What is the correct way to start a PHP script?`,
        options: [
            "<?php",
            "<php>",
            "<script>",
...
?>`,
    ...
    {
        prompt: ` Which of the following is NOT a valid PHP variable name?`,
        options: [
            "$1variable",
            "$variable1",
            "$_variable",
    ...
    {
        prompt: ` How do you write a single-line comment in PHP?`,
        options: [
            "// Comment",
            "/* Comment */",
            "# Comment",
    ...
    {
        prompt: ` What does the "isset()" function do in PHP?`,
        options: [
    ...
    {
        prompt: ` Which superglobal array is used to collect form data in PHP?`,
