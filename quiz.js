let questions = [
    ...
    {
        prompt: `In JavaScript, what is a block of statement?`,
    ...
    {
        prompt: ` Which of the following variables takes precedence\n over the others if the names are the same?`,
    ...
    {
        prompt: `In JavaScript, what is used for handling errors?`,
        options: ["Catch", "Throw", "Try-catch-finally", "Error-handling"],
        answer: "Try-catch-finally",
    },
    {
        prompt: `Which built-in method sorts the elements of an array?`,
        options: ["order()", "sort()", "arrange()", "None of the above"],
        answer: "sort()",
    },
    {
        prompt: ` What keyword is used to define an asynchronous function in JavaScript?`,
