let questions = [
    {
        prompt: `Choose the correct synonym for the word "Abundant".`,
        options: ["Scarce", "Plentiful", "Little", "Sparse"],
        answer: "Plentiful",
    },
    {
        prompt: ` Identify the correct antonym of "Eloquent".`,
    ...
    {
        prompt: `What is the meaning of the idiom "A blessing in disguise"?`,
        options: [
    ...
    {
        prompt: ` Identify the sentence with correct grammar.`,
        options: [
    ...
    {
        prompt: ` Choose the correct synonym for the word "Ambiguous".`,
        options: ["Clear", "Uncertain", "Definite", "Exact"],
        answer: "Uncertain",
    },
    {
        prompt: ` What does the phrase "Break the ice" mean?`,
        options: [
    ...
    {
        prompt: ` Identify the correct antonym of "Hostile".`,
        options: ["Aggressive", "Friendly", "Angry", "Rude"],
        answer: "Friendly",
    },
    {
        prompt: ` Fill in the blank: "She ____ to the market yesterday."`,
        options: ["go", "gone", "went", "going"],
        answer: "went",
    },
    {
        prompt: ` What is the correct plural form of "Analysis"?`,
